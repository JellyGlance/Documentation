# ![homarr](../icons/brands/homarr.svg){ .page-brand } Homepage and Homarr widgets
...
See the downloadable Homarr widgets and Homepage YAML below. Replace the example host and add your API key in your dashboard settings.
...
Use the [API cookbook](../reference/api-cookbook.md) for copyable curl requests, example responses, and dashboard imports.
